...
public class AdapterGastronomia extends RecyclerView.Adapter<AdapterGastronomia.MyViewHolder> {
    ...
    public void onBindViewHolder(final AdapterGastronomia.MyViewHolder holder, final int position) {
        try{
            ...
            if(isLang){
                holder.textView_descripcion_restaurante.setText(respuesta.get(position).getString("descripcion_ing"));
            } else {
            ...
            cardView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    try {
                        ...
                        bundle.putString("descripcion", textView_descripcion_restaurante.getText().toString());
